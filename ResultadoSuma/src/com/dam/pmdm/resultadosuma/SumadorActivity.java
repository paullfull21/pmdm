...
public class SumadorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Rescatar el intent que lanzó este Activity, para obtener
		//los parámetros (operando1 y operando2) que se añadieron 
		//al intent
		...
		if(operandoUno==null || operandoDos==null) {
			...
			//con el método setResult devuelvo una respuesta al activity
			//MainActivity que lanzó este activity. La respuesta será recibida
			//en el método onActivityResult del MainActivity.
			setResult(RESULT_CANCELED, resultado);
			
			//Invoco al método finish para destruir esta actividad.
			finish();	
		} else {
